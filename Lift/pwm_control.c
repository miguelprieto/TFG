	/* controllo e gestione modulo pwm */
...
void init_pwm()
{
    ...
    */
    ...
    /* impostiamo due uscite di controllo di frenata */

    TRISAbits.TRISA2 = PORT_OUT;		// sinistra
    TRISAbits.TRISA3 = PORT_OUT;		// destra
    PORTAbits.RA2 = 0;
    PORTAbits.RA3 = 0;
...
void set_pwm(int channel, int set)
{
...
/* funzioni per mettere in stop i motori */
